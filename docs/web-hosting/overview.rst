.. _web-hosting-pipeline-overview:
...
The WebHosting Pipeline generates JSON files corresponding to the page and book
...
Work for the WebHosting Pipeline is defined using a JSON file that can be accessed
...
The above captures the general design of the WebHosting Pipeline. In staging
