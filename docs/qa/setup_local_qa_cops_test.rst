...
================================================================
Setting up local qa cops test environs (still under development)
================================================================
...
This is the pipeline which is used under the hood for `Content Output Producer (COPS) <https://cops.cnx.org/>`_
