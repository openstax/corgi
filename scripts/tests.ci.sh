...
docker-compose -f docker-stack.yml exec -T backend-tests pytest ./tests -vvv -m "integration and ui" --junitxml="${TEST_RESULTS}" --base-url ${BASE_URL}
