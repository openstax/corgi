...
class Home(Page):
    ...
    _previous_page_button_locator = (
        By.CSS_SELECTOR,
        "#app > div > main > div > div > div > div > div.d-md-flex "
        "> button:nth-child(1) > span",
    )
    _next_page_button_locator = (
        By.CSS_SELECTOR,
        "#app > div.v-application--wrap > main > div > div > div "
        "> div > div.d-md-flex > "
    ...
    _go_button_locator = (
        By.CSS_SELECTOR,
        "#app > div.v-application--wrap > main > div > div > div "
        "> div > div.d-md-flex > button:nth-child(5) > span",
    )
