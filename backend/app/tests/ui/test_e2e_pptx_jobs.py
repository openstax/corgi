...
def test_e2e_pptx_jobs(chrome_page_slow, corgi_base_url, repo, book):
    ...
    # THEN: A new job is queued, verified and aborted
    ...
    assert "PPTX (git)" in home.job_id_dialog_title.inner_text()
