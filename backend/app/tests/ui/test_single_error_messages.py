...
def test_single_same_error_message(chrome_page, corgi_base_url):
...
@pytest.mark.ui
@pytest.mark.nondestructive
def test_single_non_dismissed_error_message(chrome_page, corgi_base_url):
    # GIVEN: Playwright, chromium and the corgi_base_url
    ...
    home.fill_book_field("astronomy")
...
@pytest.mark.ui
@pytest.mark.nondestructive
def test_incorrect_book_corrected(chrome_page, corgi_base_url):
    # GIVEN: Playwright, chromium and the corgi_base_url
...
@pytest.mark.ui
@pytest.mark.nondestructive
def test_incorrect_repo_corrected(chrome_page, corgi_base_url):
    # GIVEN: Playwright, chromium and the corgi_base_url
...
@pytest.mark.ui
@pytest.mark.nondestructive
def test_incorrect_version_corrected(chrome_page, corgi_base_url):
    # GIVEN: Playwright, chromium and the corgi_base_url
...
@pytest.mark.ui
@pytest.mark.nondestructive
def test_invalid_repo_error_message(chrome_page, corgi_base_url):
    # GIVEN: Playwright, chromium and the corgi_base_url
