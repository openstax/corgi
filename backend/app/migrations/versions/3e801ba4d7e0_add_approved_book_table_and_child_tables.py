...
def upgrade():
    ...
    op.create_index(
        op.f("ix_code_version_created_at"),
        "code_version",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_code_version_id"), "code_version", ["id"], unique=False
    )
    op.create_index(
        op.f("ix_code_version_updated_at"),
        "code_version",
        ["updated_at"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_consumer_created_at"), "consumer", ["created_at"], unique=False
    )
    op.create_index(op.f("ix_consumer_id"), "consumer", ["id"], unique=False)
    op.create_index(
        op.f("ix_consumer_updated_at"), "consumer", ["updated_at"], unique=False
    )
    op.create_table(
        "approved_book",
    ...
    op.create_index(
        op.f("ix_approved_book_book_id"),
        "approved_book",
        ["book_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_approved_book_code_version_id"),
        "approved_book",
        ["code_version_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_approved_book_consumer_id"),
        "approved_book",
        ["consumer_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_approved_book_created_at"),
        "approved_book",
        ["created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_approved_book_updated_at"),
        "approved_book",
        ["updated_at"],
        unique=False,
    )
...
def downgrade():
    ...
    op.drop_index(
        op.f("ix_approved_book_updated_at"), table_name="approved_book"
    )
    op.drop_index(
        op.f("ix_approved_book_created_at"), table_name="approved_book"
    )
    op.drop_index(
        op.f("ix_approved_book_consumer_id"), table_name="approved_book"
    )
    op.drop_index(
        op.f("ix_approved_book_code_version_id"), table_name="approved_book"
    )
