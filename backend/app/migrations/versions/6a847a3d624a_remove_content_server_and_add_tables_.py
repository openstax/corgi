"""remove content_server and add tables for ABL

Revision ID: 6a847a3d624a
Revises: dd5b4a5068a6
Create Date: 2022-10-02 22:45:08.301819
...
def upgrade():
    ...
    sa.Column('book_uuid', sa.String(length=36), nullable=False),
    sa.Column('job_id', sa.Integer(), nullable=False),
    sa.Column('approved', sa.Boolean(), nullable=False),
    sa.ForeignKeyConstraint(['book_uuid'], ['book.uuid'], ),
    sa.ForeignKeyConstraint(['job_id'], ['jobs.id'], ),
    sa.PrimaryKeyConstraint('book_uuid', 'job_id')
    )
    op.create_index(op.f('ix_book_job_book_uuid'), 'book_job', ['book_uuid'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_book_job_book_uuid'), table_name='book_job')
