...
def upgrade():
    ...
    server_data = [
        ...
        {
            "name": "content06",
            "hostname": "content06.cnx.org",
            "host_url": "https://content06.cnx.org",
            "created_at": utcnow,
            "updated_at": utcnow,
        },
    ]
...
def downgrade():
    bind = op.get_bind()
    delete_seed = content_servers_table.delete().where(
        content_servers_table.c.name.in_(["production", "content06"])
    )
