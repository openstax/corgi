...
def upgrade():
    op.create_index(
        op.f("ix_jobs_collection_id"), "jobs", ["collection_id"], unique=False
    )
    op.create_index(
        op.f("ix_jobs_created_at"), "jobs", ["created_at"], unique=False
    )
...
def downgrade():
    ...
    op.create_index(
        "ix_events_created_at", "jobs", ["created_at"], unique=False
    )
    op.create_index(
        "ix_events_collection_id", "jobs", ["collection_id"], unique=False
    )
