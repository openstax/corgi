...
repository_permission_table = sa.table(
...
def upgrade():
    ...
    op.create_index(
        op.f("ix_repository_id"), "repository", ["id"], unique=False
    )
    op.create_table(
        "repository_permission",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_repository_permission_id"),
        "repository_permission",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_user_repository_permission_id"),
        "user_repository",
        ["permission_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_user_repository_user_id"),
        "user_repository",
        ["user_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_book_commit_id"), "book", ["commit_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_book_job_book_id"), "book_job", ["book_id"], unique=False
    )
    op.create_index(
        op.f("ix_book_job_job_id"), "book_job", ["job_id"], unique=False
    )
    op.create_index(
        op.f("ix_job_types_created_at"),
        "job_types",
        ["created_at"],
        unique=False,
    )
    ...
    op.drop_constraint(
        "events_content_server_id_fkey", "jobs", type_="foreignkey"
    )
...
def downgrade():
    ...
    op.add_column(
        "jobs",
        sa.Column(
            "collection_id", sa.VARCHAR(), autoincrement=False, nullable=True
        ),
    )
    op.add_column(
        "jobs",
    ...
    op.create_index(
        "ix_jobs_collection_id", "jobs", ["collection_id"], unique=False
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "hostname", sa.VARCHAR(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "host_url", sa.VARCHAR(), autoincrement=False, nullable=False
        ),
        sa.Column(
            "created_at",
    ...
    op.create_index(
        "ix_content_servers_id", "content_servers", ["id"], unique=False
    )
    op.create_index(
        "ix_content_servers_created_at",
        "content_servers",
        ["created_at"],
        unique=False,
    )
    ...
    op.drop_table("book")
    op.drop_index(
        op.f("ix_user_repository_user_id"), table_name="user_repository"
    )
    op.drop_index(
        op.f("ix_user_repository_permission_id"), table_name="user_repository"
    )
    ...
    op.drop_table("user")
    op.drop_index(
        op.f("ix_repository_permission_id"), table_name="repository_permission"
    )
